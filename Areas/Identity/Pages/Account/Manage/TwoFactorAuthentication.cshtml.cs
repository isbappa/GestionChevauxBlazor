...
namespace GestionChevauxBlazor.Areas.Identity.Pages.Account.Manage
{
    public class TwoFactorAuthenticationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPost()
        {
            ...
            StatusMessage = "Le navigateur actuel a été oublié. Lorsque vous vous connectez à nouveau à partir de ce navigateur, vous serez invité à entrer votre code 2fa.";
