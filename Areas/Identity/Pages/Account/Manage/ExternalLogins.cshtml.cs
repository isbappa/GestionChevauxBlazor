...
namespace GestionChevauxBlazor.Areas.Identity.Pages.Account.Manage
{
    public class ExternalLoginsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (user == null)
            {
                return NotFound($"Impossible de charger l'utilisateur avec l'ID 'user.Id'.");
            }
        ...
        public async Task<IActionResult> OnGetLinkLoginCallbackAsync()
        {
            ...
            if (info == null)
            {
                throw new InvalidOperationException($"Une erreur inattendue s'est produite lors du chargement des informations de connexion externes pour l'utilisateur avec ID '{user.Id}'.");
            }
